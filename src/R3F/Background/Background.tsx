...
const BackgroundMaterial = shaderMaterial(
  {
    ...
    u_BlurCirclePos: new THREE.Vector2(-460, -100),
...
const Background = () => {
  ...
  const { xPosition, yPosition, CircleXPos, CircleYPos, scale } = useControls(
    'Background',
    {
      ...
      CircleXPos: { value: -460, min: -1000, max: 1000, step: 10 }, // Control y axis
      CircleYPos: { value: -100, min: -1000, max: 1000, step: 10 }, // Control y axis
